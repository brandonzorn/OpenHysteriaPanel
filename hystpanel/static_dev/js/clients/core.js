(() => {
    ...
    function cacheElements() {
        ...
        elements.inputTitle = document.getElementById('id_title');
        elements.inputUsername = document.getElementById('id_username');
        elements.inputPassword = document.getElementById('id_password');
        elements.generatePasswordButton = document.getElementById('generatePasswordButton');
        elements.inputUpload = document.getElementById('id_upload_limit_mbps');
        elements.inputDownload = document.getElementById('id_upload_download_mbps');
        elements.inputTraffic = document.getElementById('id_traffic_limit_gb');
        elements.inputExpires = document.getElementById('id_expires_at');
